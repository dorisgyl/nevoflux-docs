// Site-wide constants, kept in sync with nevoflux-www (src/constants/index.ts).
export const appName = 'NevoFlux';
export const siteDescription = 'NevoFlux — The AI-Native Browser';
