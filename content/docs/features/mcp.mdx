...
[Settings → MCP Servers](/docs/settings/mcp-servers). Their tools become available to
...
> the [agent repo](https://github.com/dorisgyl/nevoflux-agent) for standalone use.
