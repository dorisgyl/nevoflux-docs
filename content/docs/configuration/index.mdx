...
**`config.toml`**. You can edit it by hand, and the [Settings](/en/docs/settings) UI
...
| `[knowledge_base]` / `[knowledge_base.brain]` | GBrain knowledge base ([details](/en/docs/knowledge-base)) |
...
| Field | Type | Meaning |
| --- | --- | --- |
| `api_key` | string | Provider API key (or use an env var — see [Providers](/en/docs/configuration/providers)) |
